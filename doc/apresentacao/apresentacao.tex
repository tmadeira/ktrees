...
%  \end{frame}
  ...
  \begin{frame}
    ...
    Um subgrafo de uma \emph{$k$-tree} é chamado de \textbf{\emph{partial $k$-tree}}. Um grafo é uma \emph{partial $k$-tree} se e só se ele tem \emph{treewidth} menor ou igual a $k$\footnote{\scriptsize Hans L. Bodlaender. Treewidth: Structure and algorithms. \emph{Structural Information and Communication Complexity}, 4474:11--25, 2007.}.
  \end{frame}
  ...
  \begin{frame}
    ...
    \begin{itemize}
      \item Todos os pacotes desenvolvidos neste trabalho possuem testes unitários que podem ser executados usando o utilitário {\tt go test}. 96\% das linhas do código são cobertas por testes.
