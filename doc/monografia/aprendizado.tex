...
Usamos essa implementação para testar o aprendizado por amostragem uniforme de \emph{$k$-trees} com cinco conjuntos de dados reais contendo de 64 a 1556 variáveis. A tabela \ref{tab:conjuntos} descreve a característica de cada um deles.
...
\begin{table}[h]
  ...
  \begin{tabular}{|l|c|c|c|c|c|c|} \hline
    ...
    & Máx. & Média & Máx. & Média & Máx. & Média \\ \hline
    kdd & 0,0755 & 0,0691 $\pm$ 0,0022 & 0,1037 & 0,1007 $\pm$ 0,0016 & 0,1468 & 0,1447 $\pm$ 0,0007 \\
    tretail & 0,0188 & 0,0156 $\pm$ 0,0019 & & & 0,0447 & 0,0444 $\pm$ 0,0002 \\
